...
const Home = ({content = () => null }) => (
  <Grid>
    ...
    <Row className="show-grid">
      <Col sm={6} md={3}>
          <Thumbnail src="dumbells.png" alt="100x100"  style={{'padding-top':'15px','border': 'none', 'backgroundColor': 'rgba(148, 134, 115, 0.4)','height':'270'}}>
      ...
      <Col sm={6} md={3}>
          <Thumbnail src="prizes.png" alt="100x100"  style={{'padding-top':'15px', 'border': 'none', 'backgroundColor': 'rgba(148, 134, 115, 0.4)','height':'270'}}>
      ...
      <Col sm={6} md={3}>
          <Thumbnail src="scale.png" alt="100x100" style={{'padding-top':'15px','border': 'none', 'backgroundColor': 'rgba(148, 134, 115, 0.4)','height':'270'}}>
      ...
      <Col sm={6} md={3}>
          <Thumbnail src="health.png" alt="100x100" style={{'padding-top':'15px','border': 'none', 'backgroundColor': 'rgba(148, 134, 115, 0.4)','height':'270'}}>
